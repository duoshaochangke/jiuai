	...
	<div class="manage">
		...
		<div class="main">
			...
			<div class="maincontent">
				<div class="postnew">
					<form action="./savepost.php?act=postok&do=save" method="post" id="postForm" enctype="multipart/form-data">
						<div class="titlediv">
							<label for="blogtitle">博文标题(不超过255个字符)</label>
							<input type="text" placeholder="文章标题" id="blogtitle" name="blogtitle">
						</div>
						<p id="empty">
							<?php
						...
						<div class="sourcediv">
							...
							<input type="text" placeholder="博文来源" id="source" name="source">
						</div>
						<div class="slinkdiv">
							<label for="slink">原文链接(不超过255个字符)：</label>
							<input type="url" placeholder="原文链接" id="slink" name="slink">
						</div>
						<div class="catdiv">
						...
						<div class="tagdiv">
							...
							<input type="text" id="blogtags" placeholder="添加标签" name="blogtags" >
						</div>
						<div class="contentdiv">
							<script id="blogcontent" type="text/plain"  name="blogcontent"></script>
						</div>
						<div class="imgdiv">
