...
<head>
	...
	<?php 
		...
		$editSql = "";
		$editRow = $jadb->getRow($editSql);
		//print_r($editRow);
		setcookie("cat",$editRow['article_category']);
	?>
	...
	<div class="manage">
		...
		<div class="main">
			...
			<div class="maincontent">
				<div class="postnew">
					<form action="./saveedit.php?act=update&do=save&uni=<?php echo $artuni;?>&oldtag=<?php echo $editRow['article_tags'] ?>" method="post" id="postForm" enctype="multipart/form-data">
						<div class="titlediv">
